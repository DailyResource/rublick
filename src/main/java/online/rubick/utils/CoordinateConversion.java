...
public class CoordinateConversion {
     ...
     * @return
     */
    public static Point gps2BD(double lat,double lng){
    	Point p = new Point();
    	p = wgs_gcj_encrypts(lat,lng);
    ...
    public static Point wgs_gcj_encrypts(double wgLat, double wgLon) {
      ...
      * @return
      */
    public static Point WGS_84_To_BD_09(double Lat, double Lon){
    	Point point = wgs_gcj_encrypts(Lat, Lon);
