...
public class CrucianAuthenticationEntryPoint implements AuthenticationEntryPoint,InitializingBean {
	...
	private static final Logger logger = LoggerFactory.getLogger(CrucianAuthenticationEntryPoint.class);
	 ...
	 * URL.
	 */
	public CrucianAuthenticationEntryPoint(String loginFormUrl) {
	...
	public void commence(HttpServletRequest request, HttpServletResponse response,
		...
		else if(WebUtil.isAjaxReq(request)){
			//Ajax请求处理
			String jsonObject = "{\"code\":2001,\"message\":\"未登录用户.\"}"; 
			WebUtil.ajaxResponse(jsonObject, HttpServletResponse.SC_FORBIDDEN, response);
            return;  
		}
		else {
